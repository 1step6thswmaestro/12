...
Namespace FMOD
    ...
    Public Delegate Function DSP_CREATECALLBACK(ByRef dsp_state As DSP_STATE) As RESULT
    Public Delegate Function DSP_RELEASECALLBACK(ByRef dsp_state As DSP_STATE) As RESULT
    Public Delegate Function DSP_RESETCALLBACK(ByRef dsp_state As DSP_STATE) As RESULT
    Public Delegate Function DSP_READCALLBACK(ByRef dsp_state As DSP_STATE, ByVal inbuffer As IntPtr, ByVal outbuffer As IntPtr, ByVal length As UInteger, ByVal inchannels As Integer, ByVal outchannels As Integer) As RESULT
    Public Delegate Function DSP_SETPOSITIONCALLBACK(ByRef dsp_state As DSP_STATE, ByVal seeklen As UInteger) As RESULT
    Public Delegate Function DSP_SETPARAMCALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByVal val As Single) As RESULT
    Public Delegate Function DSP_GETPARAMCALLBACK(ByRef dsp_state As DSP_STATE, ByVal index As Integer, ByRef val As Single, ByVal valuestr As StringBuilder) As RESULT
    Public Delegate Function DSP_DIALOGCALLBACK(ByRef dsp_state As DSP_STATE, ByVal hwnd As IntPtr, ByVal show As Boolean) As RESULT
    ...
    Public Enum DSP_TYPE As Integer
        UNKNOWN
    ...
    Public Structure DSP_PARAMETERDESC
    ...
    Public Structure DSP_DESCRIPTION
        ...
        Public create As DSP_CREATECALLBACK
        ' [in] Create callback.  This is called when DSP unit is created.  Can be null. 
        Public release As DSP_RELEASECALLBACK
        ...
        Public reset As DSP_RESETCALLBACK
        ...
        Public read As DSP_READCALLBACK
        ' [in] Read callback.  Processing is done here.  Can be null. 
        Public setposition As DSP_SETPOSITIONCALLBACK
        ' [in] Setposition callback.  This is called if the unit wants to update its position info but not process data.  Can be null. 

        Public numparameters As Integer
        ' [in] Number of parameters used in this filter.  The user finds this with DSP::getNumParameters 
        Public paramdesc As DSP_PARAMETERDESC()
        ' [in] Variable number of parameter structures. 
        Public setparameter As DSP_SETPARAMCALLBACK
        ' [in] This is called when the user calls DSP::setParameter.  Can be null. 
        Public getparameter As DSP_GETPARAMCALLBACK
        ' [in] This is called when the user calls DSP::getParameter.  Can be null. 
        Public config As DSP_DIALOGCALLBACK
    ...
    Public Enum DSP_HIGHPASS
        CUTOFF
        ' Highpass cutoff frequency in hz.  10.0 to output 22000.0.  Default = 5000.0. 
        RESONANCE
    ...
    Public Enum DSP_ECHO
        ...
        DECAYRATIO
        ' Echo decay per delay.  0 to 1.  1.0 = No decay, 0.0 = total decay.  Default = 0.5. 
        MAXCHANNELS
    ...
    Public Enum DSP_COMPRESSOR
        THRESHOLD
        ' Threshold level (dB)in the range from -60 through 0. The default value is 50. 
        ATTACK
        ...
        GAINMAKEUP
        ' Make-up gain applied after limiting, in the range from 0.0 through 100.0. The default value is 50. 
    End Enum
    ...
    Public Enum DSP_SFXREVERB
        DRYLEVEL
        ' Dry Level      : Mix level of dry signal in output in mB.  Ranges from -10000.0 to 0.0.  Default is 0.0. 
        ROOM
